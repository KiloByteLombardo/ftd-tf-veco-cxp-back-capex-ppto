...
COLUMN_MAPPING = {
    ...
    'Id Cta': 'vzla_capex_ppto_codigo_cuenta',
    'Método de Pago': 'vzla_capex_ppto_metodo_pago',
    'Pago Independiente': 'vzla_capex_ppto_pago_independiente',
    'Prioridad': 'vzla_capex_ppto_prioridad_origen',
    ...
    'Monto Capex ORD 2': 'vzla_capex_ppto_monto_capex_ord_2',
    'Monto Capex EXT 3': 'vzla_capex_ppto_monto_capex_ext_3',
    ...
    'Dia de Pago': 'vzla_capex_ppto_dia_pago',
    ...
    'AREA': 'vzla_capex_ppto_area',
    'Tipo Capex': 'vzla_capex_ppto_tipo_capex',
    'Tipo Capex 2': 'vzla_capex_ppto_tipo_capex_2'
}
